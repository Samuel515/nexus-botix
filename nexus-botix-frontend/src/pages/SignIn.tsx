...
<div className="min-h-screen flex items-center justify-center bg-black">
          <div className=" text-white p-8 rounded-lg shadow-lg max-w-md w-full">
              ...
              <p className="text-center mb-6">Sign in to <span className="font-bold">Nexus Botix</span></p>
              ...
              <div className="text-center my-6">
                  <p>Don't have an account? <a href="#" className="text-yellow-500 hover:underline">Sign UP</a></p>
              </div>
