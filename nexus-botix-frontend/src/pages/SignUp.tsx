  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-black">
          <div className=" text-white p-8 rounded-lg shadow-lg max-w-md w-full">
              ...
              <p className="text-center mb-6">Sign up to <span className="font-bold">Nexus Botix</span></p>
                      ...
                      >
                          ...
                          >
                              <path
                                  ...
                                  strokeWidth="2"
                                  d={showPassword ? "M13.875 18.825A10.05 10.05 0 0012 19c-5.523 0-10-4.477-10-10S6.477 3 12 3c2.386 0 4.577.832 6.284 2.219m-2.484 1.776a3 3 0 11-3.775 3.775M15 15l6 6"
              ...
              <div className="text-center my-6">
                  <p>Already have an account? <a href="#" className="text-yellow-500 hover:underline">Log In</a></p>
              </div>
