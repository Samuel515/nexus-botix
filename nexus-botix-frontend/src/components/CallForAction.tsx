  ...
  return (
    <div className="relative overflow-hidden flex justify-center items-center flex-col gap-10 bg-custom-white-bg text-black py-12 px-6 rounded-3xl h-[450px] lg:h-max">
      <h2 className="~text-xl/4xl text-center font-semibold lg:font-bold leading-relaxed z-10">
        Join 300,000+ businesses accelerating their growth with Nexus
        Botix{" "}
      </h2>
      ...
      <img src={bgCfa} alt="background" className="absolute lg:right-0 -right-[26%] top-0 lg:top-auto"/>
      <img src={bgCfaII} alt="background" className="absolute lg:left-0 -left-[26%] bottom-0 lg:bottom-auto"/>
    </div>
  );
}
